...
function Queries(props) {
    ...
    return (
        <>
             ...
             <div>
                <SpanTag color="#0076FF">Queries</SpanTag>
                <input className="input-field" name="" placeholder="search heare"></input>
                 Filter : <input name=""></input> Sort : <input name=""></input>
                 {/* <NormalButton color="#FFFFFF" >Create a Query</NormalButton> */}
                 <Link href="/queries/create" params={{ PageTittle: "Query" }}>
                     <NormalButton color="#FFFFFF" margin="-34px 63px 10px 78%" >Create a Query</NormalButton>
                ...
                <section className="hero">
                    ...
                    <SpanTag margin="0px 0px 0px 20%" color="#0076FF">Connect a Query</SpanTag>
                    </div>
                    {/* <span className="create-datasrc"><img src="/static/images/dashboard-create.png"></img></span> */}
